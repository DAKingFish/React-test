...
export default function Register(props: any) {
  ...
  return (
    <div className={styles.register}>
      ...
      />
      <div className={styles.rgTitle}>注册账号</div>
      <Form className={styles.selectContext} onFinish={onFinishRg}>
        ...
        >
          <Input
            className={styles.rgPhoneNumber}
            bordered={true}
            maxLength={11}
            placeholder={'请输入手机号码'}
          />
        ...
        >
          <Input
            className={styles.rgCode}
            bordered={true}
            maxLength={4}
            placeholder={'请输入短信验证码'}
            value={code}
            suffix={<div className={styles.rgCRequest}>获取验证码</div>}
          />
        </Form.Item>
        <Form.Item
          style={{ marginBottom: '32px' }}
        ...
        <Form.Item style={{ marginBottom: '9px' }}>
          <ConfigProvider autoInsertSpaceInButton={false}>
            <Button
              type="primary"
              htmlType="submit"
              className={styles.rgLoginButton}
            >
              注册
            </Button>
          </ConfigProvider>
